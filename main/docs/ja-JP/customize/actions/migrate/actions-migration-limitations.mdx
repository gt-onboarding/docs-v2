...
詳細は、「[アクションへの移行](/docs/ja-JP/ja-jp/customize/actions/migrate)」を参照してください。
...
* [`accessToken`](/docs/ja-JP/ja-jp/libraries/lock/lock-api-reference#getuserinfo-)は現在、100スコープに制限されています。
...
* アクションは現在、[`event.user.identities`](/docs/ja-JP/ja-jp/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger/post-login-event-object)内で以下のプロパティのみに対応しています。
