...
詳細については、「[Auth0ルール](/docs/ja-JP/ja-jp/customize/rules)」をお読みください。
...
詳細については、「[カスタムクレームを作成する](/docs/ja-JP/ja-jp/secure/tokens/json-web-tokens/create-custom-claims)
...
詳細については、[ルールを使用したメタデータの管理](/docs/ja-JP/ja-jp/manage-users/user-accounts/metadata/manage-metadata-rules)をお読みください。
