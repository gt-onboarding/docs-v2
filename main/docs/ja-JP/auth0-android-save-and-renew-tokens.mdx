...
Credential Managers（資格情報マネージャー）は、Auth0.Android SDKの一部として含まれています。これがまだ、ユーザーの依存関係の一部でない場合は、[Auth0.Android](/docs/ja-JP/ja-jp/libraries/auth0-android)の指示に従ってください。
