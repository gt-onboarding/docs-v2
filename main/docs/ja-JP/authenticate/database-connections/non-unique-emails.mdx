...
For more information about identifiers and attributes, read [Flexible Identifiers](/docs/ja-JP/ja-jp/authenticate/database-connections/flexible-identifiers-and-attributes).
