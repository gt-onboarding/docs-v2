...
このスクリプトは[レガシー認証シナリオ](/docs/ja-JP/ja-jp/authenticate/database-connections/custom-db/overview-custom-db-connections)でのみ使用され、ユーザーをAuth0と外部のデータベースから同時に削除したい場合には必須です。
