...
このドキュメントでは、カスタマーエッジネットワークをセットアップする方法について説明します。さまざまなエッジネットワーク構成の解説は、このドキュメントの範囲外です。詳細については、「[カスタムドメイン](/docs/ja-JP/ja-jp/customize/custom-domains)」を参照してください。
