       ...
       <table class="table">
         ...
         <tbody>
           ...
           <tr>
             ...
             <td>`update:clients`と`update:credentials`のスコープを持つ<a href="/docs/ja-JP/ja-jp/secure/tokens/access-tokens/management-api-access-tokens">Management APIのアクセストークン</a>。</td>
           </tr>
         </tbody>
       </table>
    ...
    6. 使用していないキーをアプリケーションから削除します。これにより、ストレージから資格情報を永久に削除します。資格情報をアプリケーションから解除しなければ、削除できません。
       ...
       <table class="table">
         ...
         <tbody>
           ...
           <tr>
             <td>`managementApiAccessToken`</td>
             <td>` delete:credentials`のスコープを持つ<a href="/docs/ja-JP/ja-jp/secure/tokens/access-tokens/management-api-access-tokens">Management APIのアクセストークン</a>。</td>
           </tr>
         </tbody>
       </table>
  </Tab>
