...
同意プロンプトをカスタマイズする方法については、「[新しいユニバーサルログインページをカスタマイズする](/docs/ja-JP/ja-jp/customize/login-pages/universal-login/customize-templates)」と「[ノーコードエディターで新しいユニバーサルログインをカスタマイズする](/docs/ja-JP/ja-jp/customize/login-pages/universal-login/customize-themes)」をお読みください。