...
Auth0 アプリケーション（クライアント）の構成にアクセスできる Hook です。
...
プロンプトおよびフローの設定にアクセスできる Hook です。
...
現在の画面に関する情報とメタデータにアクセスできる Hook です。
...
トランザクションの state と認証フローのデータにアクセスできる Hook です。
...
URL パラメーターやフォーム送信からの信頼できないデータにアクセスできる Hook です。
...
ユーザー情報およびプロファイルデータにアクセスできる Hook です。
