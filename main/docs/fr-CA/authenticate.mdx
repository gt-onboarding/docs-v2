...
<Card title="Connexion" href="/docs/fr-CA/fr-ca/authenticate/login">
  Choisissez parmi une variété d’options de connexion utilisateur.
</Card>

<Card title="Authentification unique" href="/docs/fr-CA/fr-ca/authenticate/single-sign-on">
...
<Card title="Sans mot de passe" href="/docs/fr-CA/fr-ca/authenticate/passwordless">
...
<Card title="Custom Token Exchange" href="/docs/fr-CA/fr-ca/authenticate/custom-token-exchange">
...
<Card title="Fournisseurs d’identités" href="/docs/fr-CA/fr-ca/authenticate/identity-providers">
  Configurez des sources de comptes d’utilisateurs pour authentifier vos applications et vos API.
</Card>

<Card title="Connexions de base de données" href="/docs/fr-CA/fr-ca/authenticate/database-connections">
...
<Card title="Connexions d’entreprise" href="/docs/fr-CA/fr-ca/authenticate/enterprise-connections">
...
<Card title="Protocoles" href="/docs/fr-CA/fr-ca/authenticate/protocols">
...
<Card title="Meilleures pratiques des paramètres de connexion" href="/docs/fr-CA/fr-ca/authenticate/connection-settings-best-practices">
