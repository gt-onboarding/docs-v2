...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  Pour connaître les limites anti-attaques associées à votre compte, lisez [Configurations de limite anti-attaques](/docs/fr-CA/fr-ca/troubleshoot/customer-support/operational-policies/rate-limit-policy/rate-limit-configurations) pour prendre connaissance de l’ensemble des politiques de limites anti-attaques.
</Callout>
...
Dans un Nuage privé, les limites de requête sont fondées sur le niveau de la performance du Nuage privé.  Pour en savoir plus, veuillez consulter [Nuage privé pour AWS](/docs/fr-CA/fr-ca/deploy-monitor/deploy-private-cloud/private-cloud-on-aws) ou [Nuage privé pour Azure](/docs/fr-CA/fr-ca/deploy-monitor/deploy-private-cloud/private-cloud-on-azure).
...
Pour les considérations relatives aux tests de charge du nuage privé, reportez-vous à [Nuage privé sur AWS](/docs/fr-CA/fr-ca/deploy-monitor/deploy-private-cloud/private-cloud-on-aws) et [Nuage privé sur Azure](/docs/fr-CA/fr-ca/deploy-monitor/deploy-private-cloud/private-cloud-on-azure).
...
Les clients qui utilisent l’extensibilité peuvent ajouter d’autres requêtes, non seulement à l’Authentication API, mais aussi à <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
...
Pour connaître l’incidence de votre configuration Auth0 sur l’utilisation de votre API, consultez les [cas d’utilisation de la limite anti-attaques](/docs/fr-CA/fr-ca/troubleshoot/customer-support/operational-policies/rate-limit-policy/rate-limit-use-cases).
...
<Card title="Limites qui protègent les utilisateurs">
  La [protection contre les attaques exhaustives](/docs/fr-CA/fr-ca/secure/attack-protection/brute-force-protection) et la [limitation des adresses IP suspectes](/docs/fr-CA/fr-ca/secure/attack-protection/suspicious-ip-throttling) de Auth0 peuvent également limiter les connexions et les inscriptions, mais elles sont indépendantes des limites anti-attaques. Pour en savoir plus sur comment Auth0 détecte et gère les anomalies potentiellement malveillantes, lisez [Protection contre les attaques](/docs/fr-CA/fr-ca/secure/attack-protection).
</Card>
...
* [Cas d’utilisation des limites anti-attaques](/docs/fr-CA/fr-ca/troubleshoot/customer-support/operational-policies/rate-limit-policy/rate-limit-use-cases)