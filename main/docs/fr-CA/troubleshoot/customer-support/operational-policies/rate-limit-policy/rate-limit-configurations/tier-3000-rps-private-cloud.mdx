...
<Accordion title="Authentication API Limites anti-attaques pour Authentication API et les points de terminaison d’API dans le type d’abonnement Performance du nuage privé 3000 RPS (30x).">
  <table class="table">
    <thead>
      <tr>
        ...
        <th><a href="/docs/fr-CA/fr-ca/troubleshoot/customer-support/operational-policies/rate-limit-policy#rate-limit-algorithm">Limite de charges subites</a></th>
  ...
  <table class="table">
    <thead>
      <tr>
        <th><a href="/docs/fr-CA/fr-ca/api/authentication#introduction"><strong>Point de terminaison</strong></a></th>
        <th><b>Méthode</b></th>
