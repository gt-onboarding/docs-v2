...
* Demandes par seconde (le test doit être conforme avec la [Politique de limites anti-attaques](/docs/fr-CA/fr-ca/troubleshoot/customer-support/operational-policies/rate-limit-policy))
...
Pour visualiser les périodes de gel des modifications actuellement planifiées, lisez [Politique de gel des modifications](/docs/fr-CA/fr-ca/troubleshoot/customer-support/operational-policies/change-freeze-policy).
...
* Le nombre de demandes par seconde du test ne doit pas dépasser les taux définis dans notre [Politique de limite anti-attaques](/docs/fr-CA/fr-ca/troubleshoot/customer-support/operational-policies/rate-limit-policy)
...
* Vous ne pouvez pas effectuer de [test de surcharge](/docs/fr-CA/fr-ca/troubleshoot/customer-support/operational-policies/load-testing-policy) (par exemple, des attaques de Déni de service) conformément à la politique sur les tests de surcharge.
...
* [Politique de tests de charge](/docs/fr-CA/fr-ca/troubleshoot/customer-support/operational-policies/load-testing-policy)