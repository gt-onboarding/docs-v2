...
De même, l’utilisation de votre domaine personnalisé dans les appels à l’[Auth0 Management API](/docs/fr-CA/fr-ca/api/management/v2) entraînera une erreur pour la même raison.
...
<div id="errors-related-to-internet-explorer">
...
Vous pouvez également supprimer le recours à l’authentification inter-origine en implémentant [Connexion universelle Auth0](/docs/fr-CA/fr-ca/authenticate/login/auth0-universal-login).
...
* [Versions et suites cryptographiques TLS (SSL)](/docs/fr-CA/fr-ca/customize/custom-domains/self-managed-certificates/tls-ssl)