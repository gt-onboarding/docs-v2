...
Si vous rencontrez des problèmes avec votre  [Connecteur AD/LDAP](/docs/fr-CA/fr-ca/authenticate/identity-providers/enterprise-identity-providers/active-directory-ldap/ad-ldap-connector), lisez ce qui suit pour savoir comment résoudre les problèmes les plus courants.
...
Pour détecter les problèmes liés aux certificats, définissez la variable `CONNECTIONS_API_V2_KEY` dans le fichier de configuration du [Connecteur AD/LDAP](/docs/fr-CA/fr-ca/authenticate/identity-providers/enterprise-identity-providers/active-directory-ldap/ad-ldap-connector/ad-ldap-connector-config-file-schema).
...
Vérifiez si le nombre d’utilisateurs actifs utilisant le Connecteur AD/LDAP a augmenté depuis son déploiement initial. Vous pouvez évaluer cela en utilisant votre propre [solution de surveillance](/docs/fr-CA/fr-ca/customize/log-streams), ou vous pouvez obtenir une estimation à partir du [rapport des utilisateurs actifs d’Auth0](/docs/fr-CA/fr-ca/troubleshoot/customer-support/manage-subscriptions/monitor-subscription-usage).
...
Vous pourriez rencontrer cette erreur si vous n’avez pas terminé la configuration supplémentaire d’un [domaine personnalisé](/docs/fr-CA/fr-ca/customize/custom-domains).
...
1. Ouvrez le [fichier de configuration du Connecteur AD/LDAP](/docs/fr-CA/fr-ca/authenticate/identity-providers/enterprise-identity-providers/active-directory-ldap/ad-ldap-connector/ad-ldap-connector-config-file-schema).
...
Si vous ne parvenez pas à résoudre l’un de ces problèmes par vous-même, [contactez le Support Auth0](/docs/fr-CA/fr-ca/troubleshoot/customer-support/open-and-manage-support-tickets).

Pour aider l’équipe de support à résoudre votre problème, incluez les éléments suivants dans votre ticket de support :

1. Description du problème.
2. Une [exportation de vos fichiers de configuration AD/LDAP](/docs/fr-CA/fr-ca/authenticate/identity-providers/enterprise-identity-providers/active-directory-ldap/ad-ldap-connector/import-export-ad-ldap-connector-configs).
...
* [Importation et exportation des configurations du connecteur AD/LDAP](/docs/fr-CA/fr-ca/authenticate/identity-providers/enterprise-identity-providers/active-directory-ldap/ad-ldap-connector/import-export-ad-ldap-connector-configs)
* [Configuration de l’environnement de test du connecteur AD/LDAP](/docs/fr-CA/fr-ca/authenticate/identity-providers/enterprise-identity-providers/active-directory-ldap/ad-ldap-connector/ad-ldap-connector-test-environment)
...
* [Schéma du fichier de configuration du connecteur AD/LDAP](/docs/fr-CA/fr-ca/authenticate/identity-providers/enterprise-identity-providers/active-directory-ldap/ad-ldap-connector/ad-ldap-connector-config-file-schema)
* [Surveillance du connecteur AD/LDAP avec System Center Operations Manager](/docs/fr-CA/fr-ca/authenticate/identity-providers/enterprise-identity-providers/active-directory-ldap/ad-ldap-connector/ad-ldap-connector-scom)