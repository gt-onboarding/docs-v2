...
2. Générez et vérifiez le [fichier HAR](/docs/fr-CA/fr-ca/troubleshoot/troubleshooting-tools/generate-and-analyze-har-files), recherchez un `id_token`.
...
7. Vérifiez que vous avez accordé la [permission](/docs/fr-CA/fr-ca/get-started/apis/scopes) adéquate pour obtenir un jeton d‘accès.
