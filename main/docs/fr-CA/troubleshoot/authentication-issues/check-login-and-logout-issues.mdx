...
* Si vous utilisez la [page de connexion universelle Auth0](/docs/fr-CA/fr-ca/authenticate/login/auth0-universal-login), essayez de désactiver la personnalisation et voyez si l’authentification fonctionne. Si la connexion fonctionne sans vos personnalisations, vérifiez le code de personnalisation de votre page de connexion universelle.
...
* Recherchez dans le [fichier HAR](/docs/fr-CA/fr-ca/troubleshoot/troubleshooting-tools/generate-and-analyze-har-files) l’appel à l’URL de rappel de votre application.
...
* Affichez les <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=json-web-token" tip="Jeton Web JSON (JWT)
...
* Affichez les assertions <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=security-assertion-markup-language" tip="Security Assertion Markup Language (SAML)
