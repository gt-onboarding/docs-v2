...
* Avez-vous un [jeton d’accès à Management API](/docs/fr-CA/fr-ca/secure/tokens/access-tokens/management-api-access-tokens)?
...
* Obtenez le jeton d’accès à partir d’un [fichier HAR](/docs/fr-CA/fr-ca/troubleshoot/troubleshooting-tools/generate-and-analyze-har-files) et testez-le dans l’[explorateur de Auth0 Management API](/docs/fr-CA/fr-ca/api/management/v2) pour voir s’il fonctionne.
...
* Si vous appelez l’Auth0 <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
  Un produit permettant aux clients d’effectuer des tâches administratives." cta="Voir le glossaire">Management API</Tooltip> à partir d’une application qui s’authentifie avec un [Flux des identifiants client](/docs/fr-CA/fr-ca/get-started/authentication-and-authorization-flow/client-credentials-flow), notez que les règles ne sont pas exécutées dans ce contexte. Pour une fonctionnalité similaire à celle d’une règle, vous pouvez utiliser une action dans le [flux intermachines](/docs/fr-CA/fr-ca/customize/actions/explore-triggers/machine-to-machine-trigger) sur le déclencheur `credentials-exchange` dans ce contexte.
...
* [Appeler votre API avec le flux de code d’autorisation avec une clé de preuve pour l’échange de code (PKCE)](/docs/fr-CA/fr-ca/get-started/authentication-and-authorization-flow/authorization-code-flow-with-pkce/call-your-api-using-the-authorization-code-flow-with-pkce)
...
* [Appeler une API à l’aide du flux d’autorisation d’appareil](/docs/fr-CA/fr-ca/get-started/authentication-and-authorization-flow/device-authorization-flow/call-your-api-using-the-device-authorization-flow)