...
Vous pouvez également utiliser le <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
...
Pour accéder à l’API, vous avez besoin d’un [jeton d’accès à Management APIv2](/docs/fr-CA/fr-ca/api/management/v2/tokens).
...
Pour plus de détails sur les critères de recherche que vous pouvez utiliser et une liste avec les acronymes d’événements, veuillez consulter le [Point de terminaison Rechercher les événements de journaux](/docs/fr-CA/fr-ca/api/management/v2#!/Logs/get_logs).
...
Le [point de terminaison Obtenir un événement de journal par ID](/docs/fr-CA/fr-ca/api/management/v2#!/Logs/get_logs_by_id) récupère l’entrée de journal associée avec l’ID fourni.
...
<div id="check-real-time-webtask-logs-error-console">
...
* [Erreurs d’obsolescence](/docs/fr-CA/fr-ca/troubleshoot/basic-issues/check-deprecation-errors)