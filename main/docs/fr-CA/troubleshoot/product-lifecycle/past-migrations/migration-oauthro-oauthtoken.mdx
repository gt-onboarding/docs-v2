...
Ce changement vous concerne si vous utilisez le [Flux de mot de passe du propriétaire de ressource](/docs/fr-CA/fr-ca/get-started/authentication-and-authorization-flow/resource-owner-password-flow) (parfois appelé Autorisation de mot de passe du propriétaire de ressource) et appelez `/oauth/ro` directement sans utiliser de bibliothèques d’Auth0 ou de trousses SDK. Les bibliothèques d’Auth0 comme Lock ou Auth0.js ont été mises à jour pour cesser d’utiliser `/oauth/ro` à l’interne. Si vous utilisez la bibliothèque lock-<Tooltip href="/docs/fr-CA/fr-ca/glossary?term=passwordless" tip="Sans mot de passe
