...
Dans auth0.js v9 et Lock 11, vous devez utiliser [Authentification silencieuse](/docs/fr-CA/fr-ca/authenticate/login/configure-silent-authentication) et `checkSession()` (voir exemple ci-dessous).
...
Une autre approche pour obtenir le profil utilisateur complet consiste à utiliser <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
