...
Vous pouvez mettre à niveau individuellement les Actions personnalisées existantes construites sur la version 12, 12 ou 18 de Node vers Node 22, puis [revenir à la version précédente](/docs/fr-CA/fr-ca/customize/actions/manage-versions#revert-actions) en utilisant l’ancien environnement d’exécution. Mettez à jour les Actions vers la version de Node 22 en créant et en déployant une nouvelle version de l’implémentation actuelle pour utiliser Node 22 comme environnement d’exécution.
