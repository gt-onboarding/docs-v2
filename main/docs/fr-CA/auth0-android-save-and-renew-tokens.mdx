...
Les gestionnaires d’identifiants sont inclus dans la trousse SDK Auth0.Android. Si cela ne fait pas encore partie de vos dépendances, suivez les directives dans [Auth0.Android](/docs/fr-CA/fr-ca/libraries/auth0-android).
...
<div id="using-the-credentialsmanager-class">
  ## Utilisation de la classe CredentialsManager
</div>

<div id="set-up-the-credentialsmanager">
...
<div id="current-state-of-the-authentication">
...
<div id="using-the-securecredentialsmanager-class">
  ## Utilisation de la classe SecureCredentialsManager
</div>

<div id="set-up-the-securecredentialsmanager">
...
<div id="pre-authenticate-the-user">
...
<div id="handling-usage-exceptions">
