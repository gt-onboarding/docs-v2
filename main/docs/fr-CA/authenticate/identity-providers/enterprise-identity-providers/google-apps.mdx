...
<div id="set-up-your-app-in-google">
...
<div id="register-a-new-application">
...
* Sur l’**écran de consentement d’<Tooltip href="/docs/fr-CA/fr-ca/glossary?term=oath2" tip="OAuth 2.0
...
<div id="enable-the-admin-sdk-api">
...
<div id="work-with-the-connection">
...
Pour utiliser votre nouvelle connexion AD, vous devez premièrement [activer la connexion](/docs/fr-CA/fr-ca/authenticate/identity-providers/enterprise-identity-providers/enable-enterprise-connections) pour vos applications Auth0.
...
<div id="request-refresh-tokens-from-google">
...
Une fois ces étapes complétées, utilisez le point de terminaison [Obtenir une connexion](/docs/fr-CA/fr-ca/api/management/v2/connections/get-connections-by-id) d&#39;Auth0 <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
...
Vous pouvez utiliser les `Actions`[post-connexion](/docs/fr-CA/fr-ca/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger) pour vérifier si les événements d’authentification proviennent d‘utilisateurs légitimes membres d’une organisation Google. Cela peut contribuer à atténuer les vulnérabilités potentielles en empêchant tout accès non autorisé à vos applications une fois que les utilisateurs ne font plus partie de votre organisation.
...
<div id="reauthorize-existing-connections">
...
* [Intégration d’Auth0 en utilisant l’une de nos bibliothèques](/docs/fr-CA/fr-ca/libraries)
* [Intégration d’Auth0 en utilisant notre Authentication API](/docs/fr-CA/fr-ca/api/authentication)
