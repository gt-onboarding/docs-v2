...
* [Enregistrer votre application sur le portail des développeurs Apple](https://marketplace.auth0.com/integrations/apple-social-connection) si vous ne l’avez pas déjà fait. Notez les ID et la clé suivants pour les réglages de connexion de l’application dans le <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
* [Révoquer le jeton d’actualisation Auth0](/docs/fr-CA/fr-ca/api/authentication#revoke-refresh-token)
