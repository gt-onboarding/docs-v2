...
* [Guide de démarrage rapide d’Android](/docs/fr-CA/fr-ca/quickstart/native/android)
* [Guide de démarrage rapide d’iOS Swift](/docs/fr-CA/fr-ca/quickstart/native/ios-swift)
...
[Connexion sans mot de passe intégrée dans les applications natives](/docs/fr-CA/fr-ca/authenticate/passwordless/implement-login/embedded-login/native)
...
* Non conforme aux meilleures pratiques <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=oath2" tip="OAuth 2.0
...
* [Ajoutez une connexion Facebook aux applications natives](/docs/fr-CA/fr-ca/authenticate/identity-providers/social-identity-providers/facebook-native)
* [Android – Connexion Facebook](/docs/fr-CA/fr-ca/quickstart/native/android-facebook-login)
* [iOS Swift – Connexion Facebook](/docs/fr-CA/fr-ca/quickstart/native/ios-swift-facebook-login)

Se connecter avec Apple :

* [iOS Swift – Se connecter avec Apple](/docs/fr-CA/fr-ca/quickstart/native/ios-swift-siwa)
* [Ajouter une connexion avec Apple aux application iOS natives](/docs/fr-CA/fr-ca/authenticate/identity-providers/social-identity-providers/apple-native)
