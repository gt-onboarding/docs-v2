...
Google ne prend plus en charge l’approche intégrée lors de l’implémentation d’<Tooltip href="/docs/fr-CA/fr-ca/glossary?term=oath2" tip="OAuth 2.0
...
* [Prévenir les menaces courantes en matière de cybersécurité](/docs/fr-CA/fr-ca/secure/security-guidance/prevent-threats)
