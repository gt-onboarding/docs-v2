...
For more information about identifiers and attributes, read [Flexible Identifiers](/docs/fr-CA/fr-ca/authenticate/database-connections/flexible-identifiers-and-attributes).
