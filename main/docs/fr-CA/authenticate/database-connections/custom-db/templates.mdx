...
* [Modifier le mot de passe](/docs/fr-CA/fr-ca/authenticate/database-connections/custom-db/templates/change-password)
* [Créer utilisateur](/docs/fr-CA/fr-ca/authenticate/database-connections/custom-db/templates/create)
* [Supprimer utilisateur](/docs/fr-CA/fr-ca/authenticate/database-connections/custom-db/templates/delete)
* [Obtenir utilisateur](/docs/fr-CA/fr-ca/authenticate/database-connections/custom-db/templates/get-user)
* [Connexion](/docs/fr-CA/fr-ca/authenticate/database-connections/custom-db/templates/login)
* [Vérifier utilisateur](/docs/fr-CA/fr-ca/authenticate/database-connections/custom-db/templates/verify)
* [Modifier l’adresse courriel](/docs/fr-CA/fr-ca/authenticate/database-connections/custom-db/templates/change-email)
