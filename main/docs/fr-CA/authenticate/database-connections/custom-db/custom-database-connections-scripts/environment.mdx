...
* Assurez-vous que votre base de données possède les champs appropriés pour stocker les attributs des profils utilisateurs, tels que **id**, **nickname**, **email**, et **password**. Pour en savoir plus sur le schéma de profil utilisateur d’Auth0 et les champs attendus, consultez [Profils utilisateurs normalisés](/docs/fr-CA/fr-ca/manage-users/user-accounts/user-profiles/normalized-user-profiles). Pour apprendre à mettre à jour des profils utilisateurs, consultez [Mise à jour des profils utilisateurs à l’aide de votre base de données](/docs/fr-CA/fr-ca/manage-users/user-accounts/user-profiles/update-user-profiles-using-your-database).
...
* [Meilleures pratiques de débogage](/docs/fr-CA/fr-ca/troubleshoot/debugging-best-practices)
* [Meilleures pratiques du déploiement](/docs/fr-CA/fr-ca/deploy-monitor/deployment-best-practices)
