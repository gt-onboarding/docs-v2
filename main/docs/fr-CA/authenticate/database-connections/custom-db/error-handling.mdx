...
Si vous utilisez Lock, vous pouvez [personnaliser les messages d’erreur](/docs/fr-CA/fr-ca/customize/login-pages/classic-login/customize-lock-error-messages) qui seront affichés en les ajoutant au dictionnaire.
