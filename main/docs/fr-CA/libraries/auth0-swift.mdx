...
<Warning>
  Assurez-vous que le paramètre [**Méthode d’authentification du point de terminaison des jetons**](/docs/fr-CA/fr-ca/get-started/applications/confidential-and-public-applications/view-application-type) est réglé sur `None`.
</Warning>
...
Ensuite, présentez la page [Connexion universelle](/docs/fr-CA/fr-ca/authenticate/login/auth0-universal-login) dans l’action de votre bouton **Connexion**.
