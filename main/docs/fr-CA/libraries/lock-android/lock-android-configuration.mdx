...
* **withAuthStyle(String, int)**: personnalise l’apparence d’une connexion donnée (nom) avec un style particulier. Consultez [ce document sur les connexions OAuth personnalisées](/docs/fr-CA/fr-ca/libraries/lock-android/lock-android-custom-theming) pour en savoir plus.
