...
Maintenant que l’application Auth0 est configurée, suivez les instructions et configurez PasswordlessLock avec `Lock.Android` comme indiqué dans la [documentation sur la connexion sans mot de passe](/docs/fr-CA/fr-ca/libraries/lock-android/v2/passwordless).

<div id="sdk-usage">
  ### Utilisation de la trousse SDK
</div>

Lock’s <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=passwordless" tip="Sans mot de passe
