...
En créant un nouvel identifiant <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=oath2" tip="OAuth 2.0
...
Si vous avez besoin d’aide, vous pouvez suivre ce [Guide des magasins de clés](/docs/fr-CA/fr-ca/android-development-keystores-hashes) pour acquérir ces valeurs.
