...
Différentes valeurs sont prises en charge pour le paramètre scope. Gardez à l’esprit que les <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=json-web-token" tip="Jeton Web JSON (JWT)
...
Pour plus d’informations sur les permissions, voir la [page de documentation des permissions](/docs/fr-CA/fr-ca/get-started/apis/scopes).
