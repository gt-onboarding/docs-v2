...
If you&#39;re looking for more detailed information while working to customize Lock for your application, check out the [configuration options](/docs/fr-CA/fr-ca/libraries/lock/lock-configuration) page or the [Lock API](/docs/fr-CA/fr-ca/libraries/lock/lock-api-reference) page!
