...
L’utilisation de permissions peut vous permettre de renvoyer des demandes données pour des champs précis de votre requête. L’ajout de paramètres à `withScope` vous permet d’ajouter plus de permissions. Voir [Permissions](/docs/fr-CA/fr-ca/get-started/apis/scopes) pour en savoir plus.
