...
Interface définissant les méthodes et propriétés disponibles pour l&#39;écran `mfa-otp-enrollment-code`.
...
Poursuit le processus d'inscription à l'AMF (MFA) avec mot de passe à usage unique (OTP) en soumettant le code OTP.
