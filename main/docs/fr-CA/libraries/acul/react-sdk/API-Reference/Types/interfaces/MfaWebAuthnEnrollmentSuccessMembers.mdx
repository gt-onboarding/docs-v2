...
Donne accès aux propriétés et aux data spécifiques de l'écran « mfa-webauthn-enrollment-success ».
...
Une promesse qui se résout lorsque l’action de poursuite est soumise avec succès.
...
try {
  ...
  // Gérer l’erreur, éventuellement en inspectant sdk.transaction.errors si la page est de nouveau rendue avec une erreur.
}
```
