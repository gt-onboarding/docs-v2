...
Il est essentiel que l'utilisateur sauvegarde ce code de manière sécurisée, car il sera requis pour de futures connexions si d'autres facteurs d'AMF (MFA) ne sont pas disponibles.
