...
Interface qui définit les méthodes et propriétés disponibles pour l’écran reset-password-mfa-voice-challenge.
...
Une promesse qui se résout lorsque le défi est envoyé.
...
Une promesse qui se résout lorsque la requête est envoyée.
