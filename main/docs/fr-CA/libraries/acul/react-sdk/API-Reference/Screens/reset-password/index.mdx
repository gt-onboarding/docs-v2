...
Hook permettant d’accéder à la configuration du prompt et aux paramètres de flux.
...
Objet écran contenant le nom de l’écran en cours, sa configuration et les données propres à cet écran
...
Hook permettant d’accéder aux données non fiables provenant des paramètres d’URL et des formulaires envoyés.
