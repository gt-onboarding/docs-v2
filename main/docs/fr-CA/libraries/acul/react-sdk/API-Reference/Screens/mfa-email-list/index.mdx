...
Hook pour accéder à la configuration de l’invite et aux paramètres de flux.
...
Hook pour accéder aux données non fiables (untrustedData) provenant des paramètres d’URL et des soumissions de formulaires.
