...
Facultatif. Si true, tente de mémoriser le navigateur pour de futurs défis AMF (MFA).
Correspond au champ de formulaire `rememberBrowser`. Ceci s’applique uniquement si `screen.showRememberDevice` est true.
</ParamField>
</ParamField>
