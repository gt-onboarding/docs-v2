...
Objet écran qui contient le nom de l’écran courant, la configuration et les données propres à cet écran
...
Le type de demande de vérification à effectuer.  
'sms' : envoie le code par message texte (SMS).  
