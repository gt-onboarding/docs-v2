...
Hook pour accéder à la configuration de la marque et du thème.
...
Hook pour accéder aux données non approuvées provenant des paramètres d'URL et des soumissions de formulaire.
