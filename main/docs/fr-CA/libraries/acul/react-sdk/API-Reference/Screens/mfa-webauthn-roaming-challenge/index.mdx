...
Hook pour accéder aux données non fiables à partir des paramètres d'URL et des soumissions de formulaires.
...
Facultatif. Si la valeur est true, tente de mémoriser le navigateur pour de futures demandes d’authentification multifacteur (AMF, MFA).
