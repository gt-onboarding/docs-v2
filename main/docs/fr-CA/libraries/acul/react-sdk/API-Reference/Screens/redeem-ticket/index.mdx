...
Hook qui permet d'accéder à la configuration et aux paramètres du locataire.
...
Hook qui permet d'accéder aux données non fiables provenant des paramètres de l'URL et des envois de formulaires.
