...
Objet contenant les entrées de l’utilisateur non fiables qui doivent être validées avant utilisation.
...
Indicateur facultatif pour mémoriser l’appareil pendant 30 jours et ignorer les futurs défis d’AMF (MFA).
</ParamField>
</ParamField>
