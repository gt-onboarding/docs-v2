...
Objet de transaction contenant l’état du flux, les données de session et les informations propres à cette transaction.
...
Hook pour accéder aux renseignements sur l’utilisateur et aux données de profil.
