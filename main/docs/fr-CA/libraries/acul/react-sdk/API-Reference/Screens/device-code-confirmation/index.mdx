...
Hook permettant d’accéder à la configuration et aux paramètres du locataire (tenant).
...
Hook permettant d’accéder aux renseignements sur l’utilisateur et aux données de profil.
