...
L’alias actuel de la clé de sécurité WebAuthn que l’utilisateur est sur le point de modifier.
Cette valeur doit être affichée à l’utilisateur pour contexte.
