...
Interface des membres pour l’écran Options de début d’inscription à l’AMF (MFA)
...
Poursuit le processus d'inscription avec le facteur choisi
...
Les options d'inscription, y compris le facteur choisi
