...
Interface définissant les méthodes et propriétés disponibles pour l’écran « reset-password-mfa-voice-challenge » (défi vocal d’AMF pour la réinitialisation du mot de passe).
...
Promesse résolue lorsque le défi est soumis.
...
Code OTP (One-Time Password) saisi par l'utilisateur.
</ParamField>
</ParamField>
...
R'envoie le code par appel vocal.

Promesse résolue lorsque le code est renvoyé.
...
Promesse résolue lorsque l'action est terminée.
...
Promesse résolue lorsque la requête est soumise.
