...
* **AI agents:** Control autonomous AI agent access to external APIs using <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=oath2" tip="OAuth 2.0
...
* **Comprehensive security controls:** Secures authentication flows with OAuth 2.0 and <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=openid" tip="OpenID
...
Leverage OAuth 2.0 and OpenID Connect to securely authenticate users with [Universal Login](/docs/fr-CA/fr-ca/authenticate/login/auth0-universal-login). With [Client-Initiated Account Linking](https://auth0.com/ai/docs/client-initiated-account-linking), AI agents can request access and connect to multiple <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=idp" tip="Fournisseur d’identité (IdP)
...
Using [Token Vault](/docs/fr-CA/fr-ca/secure/tokens/token-vault), AI agents can fetch <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=access-token" tip="Jeton d’accès
...
* [Client-Initiated Backchannel Authentication (CIBA)](/docs/fr-CA/fr-ca/get-started/authentication-and-authorization-flow/client-initiated-backchannel-authentication-flow): Enables AI agents to asynchronously implement secure backchannel authentication and <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-5" tip="">authorization flows</Tooltip> when user approval is required before taking an action.
* [Rich Authorization Requests (RAR)](/docs/fr-CA/fr-ca/get-started/authentication-and-authorization-flow/authorization-code-flow/authorization-code-flow-with-rar): Enhance security by requesting specific authorization permissions for users to approve through push notifications.
