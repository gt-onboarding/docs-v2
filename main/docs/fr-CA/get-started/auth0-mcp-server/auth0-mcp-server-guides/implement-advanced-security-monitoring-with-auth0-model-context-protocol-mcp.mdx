...
For medium-risk logins that require additional verification, you&#39;ll want to create a custom [Form](/docs/fr-CA/fr-ca/customize/forms) that explains the situation to the user.
