...
<div id="configure-consent-policy-for-the-resource-server">
  ## Prérequis
</div>

Avant de configurer les RAR pour une API, il faut d’abord configurer :

* Un [domaine personnalisé](/docs/fr-CA/fr-ca/customize/custom-domains).
* Un modèle de [pages de connexion universelles personnalisées](/docs/fr-CA/fr-ca/customize/login-pages/universal-login/customize-templates). Consultez le document [Modèles de pages API](/docs/fr-CA/fr-ca/customize/universal-login-pages/universal-login-page-templates#page-templates-api) pour savoir comment personnaliser un modèle de page de connexion universelle à l’aide du <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
