...
Chaque utilisateur du <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
Principal produit d’Auth0 pour configurer vos services." cta="Voir le glossaire">Auth0 Dashboard</Tooltip> doit s’inscrire lui-même à l’authentification multifacteur (<Tooltip href="/docs/fr-CA/fr-ca/glossary?term=multifactor-authentication" tip="Authentification multifacteur (MFA)
...
* [Authentification multifacteur pour les utilisateurs du Dashboard](/docs/fr-CA/fr-ca/get-started/manage-dashboard-access/add-change-remove-mfa)
