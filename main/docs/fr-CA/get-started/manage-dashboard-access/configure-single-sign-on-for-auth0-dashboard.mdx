...
Vous pouvez configurer Auth0 pour qu’il autorise les [membres locataires](/docs/fr-CA/fr-ca/get-started/manage-dashboard-access) à utiliser votre propre [fournisseur d’identité Enterprise](/docs/fr-CA/fr-ca/authenticate/identity-providers/enterprise-identity-providers) (<Tooltip href="/docs/fr-CA/fr-ca/glossary?term=idp" tip="Fournisseur d’identité (IdP)
Service de stockage et de gestion des identités numériques." cta="Voir le glossaire">IdP</Tooltip>) pour s’authentifier auprès de <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
Principal produit d’Auth0 pour configurer vos services." cta="Voir le glossaire">Auth0 Dashboard</Tooltip> via l’authentification unique (<Tooltip href="/docs/fr-CA/fr-ca/glossary?term=single-sign-on" tip="Authentification unique (SSO)
...
* Les invitations de membres locataires ne peuvent ni être automatisées, ni être envoyées en masse avec Auth0 <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
...
* La <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=multifactor-authentication" tip="Authentification multifacteur (MFA)
...
[Ouvrez un ticket auprès de l’équipe Auth0 Support](/docs/fr-CA/fr-ca/troubleshoot/customer-support/open-and-manage-support-tickets) pour partager vos données de configuration IdP pour qu’elles puissent configurer SSO. Donnez les informations suivantes lorsque vous envoyez votre ticket :
...
Auth0 prend en charge la configuration de SSO pour le Dashboard avec un IdP <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=security-assertion-markup-language" tip="Security Assertion Markup Language (SAML)
...
2. [Ajoutez la demande de courriel](/docs/fr-CA/fr-ca/secure/tokens/json-web-tokens/create-custom-claims) au jeton d’ID.
...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  Auth0 Support utilisera le [mode Implicit avec le flux Form Post](/docs/fr-CA/fr-ca/get-started/authentication-and-authorization-flow/implicit-flow-with-form-post), si disponible. Si votre IdP ne le prend pas en charge, vous aurez alors besoin de lui fournir le secret client de votre application.
</Callout>
...
Si vous utilisez Auth0 Teams avec votre locataire Enterprise, vous pouvez imposer l’authentification SSO aux locataires qui appartiennent au compte Teams. Pour en savoir plus sur l’administration et la gestion des locataires, lisez [Auth0 Teams](/docs/fr-CA/fr-ca/get-started/auth0-teams).
...
3. [Configurez les politiques de sécurité](/docs/fr-CA/fr-ca/get-started/auth0-teams/configure-security-policies) en sélectionnant **Imposer la connexion unique**.

<div id="enable-home-realm-discovery-optional">
  ### Activer Home Realm Discovery (facultatif)
</div>

Si vous utilisez <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=universal-login" tip="Connexion universelle
...
1. [Créez une invitation de membre locataire](/docs/fr-CA/fr-ca/get-started/manage-dashboard-access/add-dashboard-users) pour le membre locataire.
...
Pour migrer des membres locataires avec la HDR activée, vous devez effectuer des étapes similaires à l’[ajout de membres locataires](/docs/fr-CA/fr-ca/get-started/manage-dashboard-access/add-dashboard-users) :
