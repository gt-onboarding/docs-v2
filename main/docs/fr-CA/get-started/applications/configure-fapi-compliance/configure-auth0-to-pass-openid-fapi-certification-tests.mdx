...
Pour passer les tests de conformité <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=openid" tip="OpenID
...
* Soit [Configurez mTLS](/docs/fr-CA/fr-ca/get-started/applications/configure-mtls) (y compris [les alias mTLS](/docs/fr-CA/fr-ca/get-started/applications/configure-mtls/configure-mtls-for-a-tenant#enable-mtls-aliases)) soit [Configurez la clé privée JWT](/docs/fr-CA/fr-ca/get-started/applications/configure-private-key-jwt)
* [Configurez la liaison de jeton mTLS](/docs/fr-CA/fr-ca/get-started/applications/configure-mtls/configure-mtls-for-a-client#enable-token-binding)
