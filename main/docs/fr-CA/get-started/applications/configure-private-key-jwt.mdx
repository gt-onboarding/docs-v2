...
L’authentification par clé privée <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=json-web-token" tip="Jeton Web JSON (JWT)
...
Vous devez [générer une paire de clés RSA](/docs/fr-CA/fr-ca/secure/application-credentials/generate-rsa-key-pair) avant de configurer votre application qui s’authentifie par clé privée JWT.
  ...
  <Tab title="Management API">
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="/docs/fr-CA/fr-ca/secure/tokens/access-tokens/management-api-access-tokens">Jeton d’accès pour Management API</a> avec la permission `create:credentials`.</td>
        </tr>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          <td>`managementApiAccessToken`</td>
          <td><a href="/docs/fr-CA/fr-ca/secure/tokens/access-tokens/management-api-access-tokens">Jeton d’accès à Management API</a> avec la permission `create:credentials`.</td>
        </tr>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          <td>`managementApiAccessToken`</td>
          <td><a href="/docs/fr-CA/fr-ca/secure/tokens/access-tokens/management-api-access-tokens">Jeton d’accès à Management API</a> avec les permissions `update:client` et `update:credentials`.</td>
        </tr>
    ...
    **Exemple**
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          <td>`managementApiAccessToken`</td>
          <td><a href="/docs/fr-CA/fr-ca/secure/tokens/access-tokens/management-api-access-tokens">Jeton d’accès pour Management API</a> avec les permissions `update:client`</td>
        </tr>
...
Pour éviter les fuites de clés, Auth0 recommande une rotation périodique de la paire de clés. Pour en savoir plus, lisez [Rotation des identifiants](/docs/fr-CA/fr-ca/get-started/applications/rotate-credentials).

<div id="learn-more">
  ## En savoir plus
</div>

* [Authentifiants d’application](/docs/fr-CA/fr-ca/secure/application-credentials)
