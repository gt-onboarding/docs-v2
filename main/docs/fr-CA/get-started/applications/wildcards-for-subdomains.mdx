...
* **Origines Web autorisées** : Liste des URL d’où peut provenir une demande d’autorisation utilisant l’[Authentification cross-origin](/docs/fr-CA/fr-ca/authenticate/login/cross-origin-authentication), le [Flux de l’appareil](/docs/fr-CA/fr-ca/get-started/authentication-and-authorization-flow/device-authorization-flow) et [web&#95;message comme mode de réponse](/docs/fr-CA/fr-ca/authenticate/protocols/oauth).
