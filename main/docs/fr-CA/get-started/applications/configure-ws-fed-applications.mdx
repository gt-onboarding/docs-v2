...
Contrairement à l’extension <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=security-assertion-markup-language" tip="Security Assertion Markup Language (SAML)
...
Pour utiliser vos applications WS-Fed avec un domaine personnalisé et avec Auth0 comme <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=idp" tip="Fournisseur d’identité (IdP)
...
* [Intégrations Auth0](/docs/fr-CA/fr-ca/customize/integrations)