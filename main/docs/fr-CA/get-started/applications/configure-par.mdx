...
L’implémentation des demandes d’autorisation poussées d’Auth0 est basée sur [RFC0126 OAuth : spécification des Demandes d’autorisation poussées](https://www.rfc-editor.org/rfc/rfc9126.html) Pour plus d’informations, veuillez consulter [Flux de code d’autorisation avec demandes d’autorisation poussées](/docs/fr-CA/fr-ca/get-started/authentication-and-authorization-flow/authorization-code-flow/authorization-code-flow-with-par).
...
1. Accédez à <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
* [Flux de code d’autorisation avec les demandes d’autorisation poussées](/docs/fr-CA/fr-ca/get-started/authentication-and-authorization-flow/authorization-code-flow/authorization-code-flow-with-par)