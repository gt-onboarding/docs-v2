...
Pour en savoir plus sur l’emplacement du nombre aléatoire, voir [Ajouter une connexion en utilisant le flux Implicite avec Form Post](/docs/fr-CA/fr-ca/get-started/authentication-and-authorization-flow/implicit-flow-with-form-post/add-login-using-the-implicit-flow-with-form-post).

<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  [Auth0.js](/docs/fr-CA/fr-ca/libraries/auth0js) gère les paramètres `state` et `nonce` pour vous lors de l’utilisation de [l’authentification cross-origin](/docs/fr-CA/fr-ca/authenticate/login/cross-origin-authentication).
</Callout>
...
Une des façons de créer un <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=nonce" tip="Nombre aléatoire
...
Lorsque Auth0 répond avec un [jeton d’ID](/docs/fr-CA/fr-ca/secure/tokens/id-tokens), ce jeton doit être [validé et décodé](/docs/fr-CA/fr-ca/secure/tokens/id-tokens/validate-id-tokens) comme d’habitude.
