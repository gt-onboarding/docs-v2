...
Validez les objets RAR en vérifiant qu’ils possèdent une propriété `type` correspondant aux types autorisés pour l’API. Pour en savoir plus, consultez [Configurer les RAR](/docs/fr-CA/fr-ca/get-started/apis/configure-rich-authorization-requests).
