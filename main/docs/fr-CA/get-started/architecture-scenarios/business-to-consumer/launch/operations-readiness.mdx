...
En outre, vous devriez consulter régulièrement la page des [migrations Auth0](/docs/fr-CA/fr-ca/troubleshoot/product-lifecycle/deprecations-and-migrations) pour obtenir des informations sur les dépréciations à venir qui pourraient obliger votre équipe à effectuer des changements.
...
* Vérifiez que vous utilisez la dernière version supportée de node.js dans [Paramètres Auth0 Dashboard](/docs/fr-CA/fr-ca/get-started/tenant-settings).
* Vérifiez que vous utilisez une version de la trousse SDK/des bibliothèques prise en charge par Auth0 conformément à la [Matrice d’assistance d’Auth0](/docs/fr-CA/fr-ca/troubleshoot/customer-support/product-support-matrix).
