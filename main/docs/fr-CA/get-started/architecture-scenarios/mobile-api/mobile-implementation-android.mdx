...
[Télécharger](/docs/fr-CA/fr-ca/package/v2?org=auth0-samples\&repo=auth0-pnp-exampleco-timesheets\&path=timesheets-mobile/android)
...
* [JWTDecode.Android](https://github.com/auth0/JWTDecode.Android) : ce package aidera à décoder les <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=json-web-token" tip="Jeton Web JSON (JWT)
