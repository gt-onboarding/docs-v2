...
* Auth0 prend en charge les normes ouvertes telles que OAuth 2.0 et <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=openid" tip="OpenID
  Norme ouverte d’authentification qui permet aux applications de vérifier l’identité des utilisateurs sans avoir à collecter leurs informations de connexion." cta="Voir le glossaire">OpenID Connect (OIDC)</Tooltip> pour l’authentification et l’autorisation (voir [Quel protocole utiliser](/docs/fr-CA/fr-ca/get-started/architecture-scenarios/sso-for-regular-web-apps/part-1#which-protocol-to-use))
* L’OIDC prend en charge plusieurs flux d’autorisation différents - le plus approprié pour les applications Web étant le flux de code d’autorisation (voir [Flux d’authentification](/docs/fr-CA/fr-ca/get-started/architecture-scenarios/sso-for-regular-web-apps/part-1#authentication-flow))
* Votre application sera configurée dans Auth0 en tant qu’application (voir [Application](/docs/fr-CA/fr-ca/get-started/architecture-scenarios/sso-for-regular-web-apps/part-2#application))
* Les fournisseurs d’identité seront configurés dans Auth0 en tant que connexion (voir [Connexions](/docs/fr-CA/fr-ca/get-started/architecture-scenarios/sso-for-regular-web-apps/part-2#connections))
* Auth0 fournit un widget Lock, qui permet aux utilisateurs de se connecter à l’application (voir [User Connexion](/docs/fr-CA/fr-ca/get-started/architecture-scenarios/sso-for-regular-web-apps/part-3#user-login))
* L’application web doit gérer l’état de la session pour garder une trace du fait que l’utilisateur est connecté. Parallèlement, Auth0 et le fournisseur d’identité gèrent également les informations de session. (voir [Gestion de session](/docs/fr-CA/fr-ca/get-started/architecture-scenarios/sso-for-regular-web-apps/part-3#session-management))
* Inversement, la déconnexion d’un utilisateur implique également trois couches de gestion de session (voir [Déconnexion de l’utilisateur](/docs/fr-CA/fr-ca/get-started/architecture-scenarios/sso-for-regular-web-apps/part-3#user-logout))
* Le contrôle d’accès peut être géré avec Auth0 Authorization Extension (voir [Contrôle d’accès](/docs/fr-CA/fr-ca/get-started/architecture-scenarios/sso-for-regular-web-apps/part-3#access-control)) :::
...
* [Présentation de la solution (applications Web + SSO)](/docs/fr-CA/fr-ca/get-started/architecture-scenarios/sso-for-regular-web-apps/part-1)
* [Configuration d’Auth0 (Applications Web + SSO)](/docs/fr-CA/fr-ca/get-started/architecture-scenarios/sso-for-regular-web-apps/part-2)
* [Mise en œuvre des applications (Applications Web + SSO)](/docs/fr-CA/fr-ca/get-started/architecture-scenarios/sso-for-regular-web-apps/part-3)
* [Mise en œuvre d’ASP.NET Core (Web Apps + SSO)](/docs/fr-CA/fr-ca/get-started/architecture-scenarios/sso-for-regular-web-apps/implementation-aspnetcore)
* [Conclusion (Applications Web + Signature unique)](/docs/fr-CA/fr-ca/get-started/architecture-scenarios/sso-for-regular-web-apps/part-4)