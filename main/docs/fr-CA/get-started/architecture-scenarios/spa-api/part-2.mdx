...
Vous devrez vous assurer que Authorization Extension est installée pour votre locataire. Vous pouvez consulter la [Documentation d’Authorization Extension](/docs/fr-CA/fr-ca/customize/extensions/authorization-extension) pour obtenir plus de détails sur la façon de procéder.
