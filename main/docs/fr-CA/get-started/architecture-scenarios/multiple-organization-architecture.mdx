...
* **Organizations Auth0** : fait référence à la fonctionnalité de locataire Auth0 conçue pour soutenir les organizations. Une instance d’une [organization Auth0](/docs/fr-CA/fr-ca/manage-users/organizations/organizations-overview) fera généralement référence à un de vos clients en particulier.
* **Employé** : personne qui travaille pour votre entreprise. Ils auront généralement un compte dans votre fournisseur d’identité (<Tooltip href="/docs/fr-CA/fr-ca/glossary?term=idp" tip="Fournisseur d’identité (IdP)
