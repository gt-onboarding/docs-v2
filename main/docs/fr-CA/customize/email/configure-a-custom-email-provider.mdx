...
Vous pouvez configurer un fournisseur de courrier électronique personnalisé à l’aide de <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  Toutes les Actions sont soumises aux mêmes [limites](/docs/fr-CA/fr-ca/customize/actions/limitations).
</Callout>
...
Pour en savoir plus sur la création et le déploiement d’actions, consultez [Créer votre première action](/docs/fr-CA/fr-ca/customize/actions/write-your-first-action).