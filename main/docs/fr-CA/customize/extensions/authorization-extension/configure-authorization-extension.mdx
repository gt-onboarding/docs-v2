...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  ...
  * [Authorization Core](/docs/fr-CA/fr-ca/manage-users/access-control/rbac)
  * [Authorization Extension](/docs/fr-CA/fr-ca/customize/extensions/authorization-extension)
...
Vous devez configurer le comportement de l’extension lors de l’opération de connexion avant que celle-ci ne puisse mettre en œuvre votre logique d’autorisation. Vos paramètres de configuration seront capturés dans une [règle](/docs/fr-CA/fr-ca/customize/rules) qui s’appliquera pendant l’exécution.

<div id="prerequisites">
  ## Prérequis
</div>

[Installer Authorization Extension](/docs/fr-CA/fr-ca/customize/extensions/authorization-extension/migrate-to-authorization-extension-v2)
...
Vous pouvez avoir des utilisateurs qui reçoivent des groupes, rôles ou autorisations de votre fournisseur d’identité (<Tooltip href="/docs/fr-CA/fr-ca/glossary?term=idp" tip="Fournisseur d’identité (IdP)
...
* [Configurer les utilisateurs dans le Tableau de bord des extensions d’autorisation](/docs/fr-CA/fr-ca/customize/extensions/authorization-extension/set-up-authorization-extension-users)
...
* [Migrer vers Extension d’autorisation v2](/docs/fr-CA/fr-ca/customize/extensions/authorization-extension/migrate-to-authorization-extension-v2)