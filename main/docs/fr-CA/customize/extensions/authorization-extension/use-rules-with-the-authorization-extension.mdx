...
Pour en savoir plus, veuillez consulter [Règles d&#39;Auth0](/docs/fr-CA/fr-ca/customize/rules).
...
Pour en savoir plus, lisez [Créer des demandes personnalisées](/docs/fr-CA/fr-ca/secure/tokens/json-web-tokens/create-custom-claims)
...
Pour plus de détails, consultez [Gérer les métadonnées avec des règles](/docs/fr-CA/fr-ca/manage-users/user-accounts/metadata/manage-metadata-rules).
