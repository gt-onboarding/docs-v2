...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  Auth0 recommande d’utiliser les paramètres des membres locataires pour désigner les capacités d’utilisation des locataires à d’autres utilisateurs et administrateurs dans votre organisation. Pour en savoir plus, consultez [Accès au Dashboard](/docs/fr-CA/fr-ca/get-started/manage-dashboard-access).
</Callout>
...
Dans cet exemple, une connexion à une base de données servira de source pour vos utilisateurs qui sont autorisés à accéder à la zone Utilisateurs. Pour ce faire, [créez une connexion à la base de données](/docs/fr-CA/fr-ca/get-started/applications/set-up-database-connections).
...
Pour ce faire, [mettez à jour les connexions de l’application](/docs/fr-CA/fr-ca/get-started/applications/update-application-connections).

<div id="create-users-for-the-database-connection">
  ### Création d’utilisateurs pour une connexion à une base de données
</div>

Pour continuer, vous devez [créer au moins un utilisateur](/docs/fr-CA/fr-ca/manage-users/user-accounts/create-users) et l’associer à votre connexion.
...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  Bien que [Delegated Administration Extension (DAE) (Extension d’administration déléguée)](/docs/fr-CA/fr-ca/customize/extensions/delegated-administration-extension) et l’ensemble de fonctionnalités [Authorization Core](/docs/fr-CA/fr-ca/manage-users/access-control/rbac) soient des fonctionnalités complètement distinctes, vous pouvez utiliser l’ensemble de fonctionnalités Authorization Core pour créer et gérer des rôles pour la DAE à l’aide d’actions. Pour en savoir plus, consultez [Exemples de cas d’utilisation : actions avec Authorization](/docs/fr-CA/fr-ca/manage-users/access-control/sample-use-cases-actions-with-authorization).
</Callout>

<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  Lorsque vous vous connectez en tant qu’utilisateur à l’aide d’organizations dotées de l’extension Delegated Administration (DAE), vos rôles d’utilisateur ne seront pas disponibles. Seuls les rôles de membre de votre organization seront disponibles dans `event.authorization.roles`. Pour ajouter des rôles aux membres de l’organisation, consultez [Ajouter des rôles aux membres de l’organisation](/docs/fr-CA/fr-ca/manage-users/organizations/configure-organizations/add-member-roles).
</Callout>
...
Lorsque vous travaillez avec des rôles, nous vous recommandons d’utiliser l’ensemble de fonctionnalités [Authorization Core](/docs/fr-CA/fr-ca/manage-users/access-control/rbac) :

1. [Créer des rôles DAE](/docs/fr-CA/fr-ca/manage-users/access-control/configure-core-rbac/roles/create-roles). Les noms des rôles que vous créez doivent correspondre aux noms des rôles DAE prédéfinis ci-dessus.
2. [Attribuer manuellement des rôles DAE à un utilisateur](/docs/fr-CA/fr-ca/manage-users/access-control/configure-core-rbac/rbac-users/assign-roles-to-users).
3. Ajoutez des rôles d’utilisateur à l’espace de noms DAE dans le jeton d’ID à l’aide des [actions](/docs/fr-CA/fr-ca/customize/actions)**:**
...
Pour en savoir plus sur la créations d’actions, consulter [Créer votre première action](/docs/fr-CA/fr-ca/customize/actions/write-your-first-action)
...
Maintenant que nous avons créé et configuré une application, une connexion et notre utilisateur, nous pouvons [installer et configurer l’extension d’administration déléguée](/docs/fr-CA/fr-ca/customize/extensions/delegated-administration-extension/install-delegated-admin-extension).
...
* [Administration déléguée : Hooks d’extension](/docs/fr-CA/fr-ca/customize/extensions/delegated-administration-extension/delegated-administration-hooks)
* [Administration déléguée : Gérer les utilisateurs](/docs/fr-CA/fr-ca/customize/extensions/delegated-administration-extension/delegated-administration-manage-users)