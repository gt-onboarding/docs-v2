...
`user.created` events are published each time a user is created. These events capture users created through a variety of channels, such as a signup page, the <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
Un produit permettant aux clients d’effectuer des tâches administratives." cta="Voir le glossaire">Management API</Tooltip>, bulk user imports, SCIM, or just-in-time provisioning (JIT), for Social, Enterprise, or <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=passwordless" tip="Sans mot de passe
...
<div id="organization-event-types">
...
<div id="organizationmemberadded">
...
<div id="organizationmemberdeleted">
...
<div id="organizationmemberroleassigned">
...
<div id="organizationmemberroledeleted">
...
<div id="organizationconnectionadded">
...
<div id="organizationconnectionupdated">
...
<div id="organizationconnectionremoved">
...
* [Create an Event Stream](/docs/fr-CA/fr-ca/customize/events/create-an-event-stream)
