...
<Warning>
  Pour utiliser les champs personnalisés, vous devez activer des [Domaines personnalisés](/docs/fr-CA/fr-ca/customize/custom-domains). L’affichage d’un formulaire avec un champ personnalisé en dehors d’un domaine personnalisé provoquera une erreur.
</Warning>
...
Ajoutez des paires clé-valeur à référencer dans le code source du champ personnalisé. Les paires clé-valeur peuvent inclure des [variables](/docs/fr-CA/fr-ca/customize/forms/variables) de champ de formulaire.
...
Pour répondre à des exigences de validation complexes, vous pouvez utiliser un [flux](/docs/fr-CA/fr-ca/customize/forms/flows).
