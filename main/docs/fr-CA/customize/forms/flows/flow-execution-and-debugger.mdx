...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  Si un champ est configuré comme transitoire ou si sa valeur est masquée par une [fonction Helper](/docs/fr-CA/fr-ca/customize/forms/variables#helper-functions), la valeur n’est pas disponible pour le débogage.
