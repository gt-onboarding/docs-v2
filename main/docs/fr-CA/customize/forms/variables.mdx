...
Si vous constatez une valeur de variable inattendue, utilisez l’aperçu [**Executions (Exécutions)**](/docs/fr-CA/fr-ca/customize/forms/flows/flow-execution-and-debugger) pour dépanner la variable.
