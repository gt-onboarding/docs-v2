...
L’extension de journaux de tâches Web en temps réel affiche en temps réel tous les journaux de code personnalisé dans votre compte, y compris toutes les sorties et exceptions `console.log`. Pour en savoir plus, consultez [Journaux de tâches Web en temps réel](/docs/fr-CA/fr-ca/customize/extensions/realtime-webtask-logs).
