...
La [connexion classique](/docs/fr-CA/fr-ca/authenticate/login/auth0-universal-login/universal-login-vs-classic-login/classic-experience) est une expérience de connexion hébergée par Auth0 qui s’appuie sur JavaScript pour la personnalisation des pages.
...
De plus, vous pouvez gérer le contenu de votre page en utilisant le [système de contrôle des versions](/docs/fr-CA/fr-ca/customize/login-pages/classic-login/version-control) de votre choix.

<div id="basic-customization">
  ## Personnalisation de base
</div>

Vous pouvez configurer les options suivantes à partir d’<Tooltip href="/docs/fr-CA/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
* [Réinitialisation du mot de passe](/docs/fr-CA/fr-ca/customize/login-pages/classic-login/customize-password-reset-page)
* [Authentification multifacteur (MFA)](/docs/fr-CA/fr-ca/secure/multi-factor-authentication/customize-mfa/customize-mfa-classic-login)
...
* [Lock](/docs/fr-CA/fr-ca/libraries/lock)
* [Lock (mode sans mot de passe)](/docs/fr-CA/fr-ca/libraries/lock)
* [Auth0.js](/docs/fr-CA/fr-ca/libraries/auth0js)
* [Authentication API](/docs/fr-CA/fr-ca/api/authentication)
...
Pour en savoir plus sur la personnalisation du gadget logiciel Lock, consultez les [Options de configuration de Lock](/docs/fr-CA/fr-ca/libraries/lock/lock-configuration).
