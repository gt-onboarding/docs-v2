...
[Lock](/docs/fr-CA/fr-ca/libraries/lock) est un formulaire de connexion qui permet à vos utilisateurs de s’authentifier facilement à l’aide d’une connexion sélectionnée. Lock gère automatiquement la plupart des détails impliqués dans la création et l’authentification des utilisateurs.
