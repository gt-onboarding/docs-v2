...
Implementing Multiple <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=custom-domain" tip="Domaine personnalisé
...
* Use [Advanced Customization for Universal Login](/docs/fr-CA/fr-ca/customize/login-pages/advanced-customizations) in your flow to implement custom logic that blocks authentication based on the domain. This can involve inspecting request parameters and then redirecting or displaying an error.
...
* Login page customizationthrough <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=universal-login" tip="Connexion universelle
...
For comprehensive guidance, please refer to general [B2B](/docs/fr-CA/fr-ca/get-started/architecture-scenarios/business-to-business/branding) and [B2C](/docs/fr-CA/fr-ca/get-started/architecture-scenarios/business-to-consumer/branding) branding guidelines.