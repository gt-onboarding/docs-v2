...
Vous pouvez lire, mettre à jour et supprimer les métadonnées à l’aide des [Règles d&#39;Auth0](/docs/fr-CA/fr-ca/customize/rules). Dans les sections suivantes, nous nous référerons à cet exemple où l’utilisateur et ses informations sont représentés par l’extrait de code JSON suivant :
...
Vous pouvez lire les métadonnées à l’aide de règles avec <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
...
En utilisant l’exemple de métadonnées ci-dessus, vous pouvez vous référer à des éléments précis de l’ensemble de données dans des [règles d&#39;Auth0](/docs/fr-CA/fr-ca/customize/rules) ou via un appel à [Management API](/docs/fr-CA/fr-ca/users/guides/manage-user-metadata) comme suit :
...
* [Utiliser Management API à partir des règles](/docs/fr-CA/fr-ca/customize/rules/use-management-api)
* [Propriétés de l’objet contexte dans les règles](/docs/fr-CA/fr-ca/customize/rules/context-object)
