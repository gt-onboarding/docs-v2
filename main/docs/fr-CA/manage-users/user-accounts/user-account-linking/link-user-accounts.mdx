...
* Utiliser <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
...
2. Redirigez vers une application de liaison externe à l’aide de la [fonctionnalité et du jeton de redirection des actions](/docs/fr-CA/fr-ca/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger/redirect-with-actions).
