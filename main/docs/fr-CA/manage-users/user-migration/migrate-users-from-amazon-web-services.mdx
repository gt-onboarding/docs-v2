...
1. [Configurez une base de données personnalisée](/docs/fr-CA/fr-ca/authenticate/database-connections/custom-db/create-db-connection) dans Auth0 et pointez-la vers votre pool d’utilisateurs AWS Cognito.
