...
* **Granite Outpost Rafting and Ziplines** : Une entreprise bien établie qui emploie directement ses guides, mais qui fait parfois appel à des guides indépendants. Ils ont leur propre fournisseur d’identité (<Tooltip href="/docs/fr-CA/fr-ca/glossary?term=idp" tip="Fournisseur d’identité (IdP)
...
Une fois que vous avez déterminé le nombre d’organizations et le modèle de connexion, vous pouvez établir des connexions de [base de données](/docs/fr-CA/fr-ca/connections/database), [social](/docs/fr-CA/fr-ca/connections/identity-providers-social), ou [entreprise](/docs/fr-CA/fr-ca/connections/identity-providers-enterprise); [créer des organizations](/docs/fr-CA/fr-ca/manage-users/organizations/configure-organizations/create-organizations); et [configuration de l’appartenance à une organization](/docs/fr-CA/fr-ca/manage-users/organizations/configure-organizations/invite-members) ou [activer les connexions d’organization](/docs/fr-CA/fr-ca/manage-users/organizations/configure-organizations/enable-connections).

<div id="roles">
  ### Rôles
</div>

Les membres des organizations peuvent se voir [attribuer des rôles.](/docs/fr-CA/fr-ca/manage-users/organizations/configure-organizations/add-member-roles) Vous pouvez utiliser ces rôles pour définir le contrôle d’accès à votre application. Par exemple, si vous avez créé un tableau de bord pour vos utilisateurs à l’aide de notre API et de nos trousses SDK, vous pouvez attribuer un rôle d’administrateur à certains membres et leur permettre de gérer eux-mêmes leur organisation par le biais de votre tableau de bord.
...
* Les applications compatibles avec les organizations ne sont pas compatibles avec les octrois et les protocoles suivants : Mot de passe de propriétaire de ressource, identifiants clients, Flux d’autorisation d&#39;appareils, <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=ws-fed" tip="Web Service Federation (WS-Fed)
