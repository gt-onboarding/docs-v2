...
Ces paramètres sont configurés sur le locataire; vous pouvez les configurer à l’aide de [Auth0 Dashboard](/docs/fr-CA/fr-ca/manage-users/sessions/configure-session-lifetime-settings) ou de <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
...
* [Mettre à jour la durée de vie du jeton d’accès](/docs/fr-CA/fr-ca/secure/tokens/access-tokens/update-access-token-lifetime)
