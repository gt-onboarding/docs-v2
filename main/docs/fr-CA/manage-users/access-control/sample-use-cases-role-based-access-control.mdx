...
Examinons un exemple des raisons pour lesquelles vous pourriez avoir besoin du [contrôle d&#39;accès basé sur les rôles (RBAC)](/docs/fr-CA/fr-ca/manage-users/access-control/rbac) dans votre flux d’autorisation et comment vous pourriez l’utiliser.
...
Au lieu de cela, vous mettez en œuvre l’autorisation basée sur les rôles,  [en créant quelques permissions](/docs/fr-CA/fr-ca/get-started/apis/add-api-permissions) dont les utilisateurs de votre module de point de vente de boutique de cadeaux auront besoin :

* `read:catalog-item`
* `read:customer-profile`
* `create:invoice`

Pour faciliter la gestion de ces autorisations, vous [créez un rôle](/docs/fr-CA/fr-ca/manage-users/access-control/configure-core-rbac/roles/create-roles) appelé `Gift Shop Manager` et [ajoutez ces autorisations à ce rôle](/docs/fr-CA/fr-ca/manage-users/access-control/configure-core-rbac/roles/add-permissions-to-roles).
