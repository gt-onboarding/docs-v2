...
Pour des exemples d’implémentations de règles avec des politiques d’autorisation, consultez [Exemples de cas d’utilisation : Règles avec autorisation](/docs/fr-CA/fr-ca/manage-users/access-control/sample-use-cases-rules-with-authorization).
