...
Pour que l’outil Auth0 Deploy CLI puisse appeler <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
...
La décision de choisir l’un ou l’autre ou les deux dépend de votre cas d’utilisation particulier et de vos préférences. Pour en savoir plus, consultez [Configurer l’outil Deploy CLI](/docs/fr-CA/fr-ca/deploy-monitor/deploy-cli-tool/configure-the-deploy-cli).
...
Pour une liste complète des drapeaux et des options, veuillez lire [Utiliser comme interface de ligne de commande](/docs/fr-CA/fr-ca/deploy-monitor/deploy-cli-tool/use-as-a-cli).