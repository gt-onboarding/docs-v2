...
Ci-dessous se trouvent des exemples de types de requêtes que vous pouvez effectuer avec <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
...
* [Migrer vers Tenant Log Search v3](/docs/fr-CA/fr-ca/troubleshoot/product-lifecycle/past-migrations/migrate-to-tenant-log-search-v3)