...
Les journaux stockés par Auth0 sont soumis à une période de rétention qui est basée sur votre abonnement Auth0. Pour en savoir plus, lisez [Rétention des données des journaux](/docs/fr-CA/fr-ca/deploy-monitor/logs/log-data-retention).
...
Pour consulter la liste des champs et des paramètres de tri pouvant être utilisés dans la requête de recherche, lisez [Syntaxe de la requête de recherche de journaux](/docs/fr-CA/fr-ca/deploy-monitor/logs/log-search-query-syntax).
