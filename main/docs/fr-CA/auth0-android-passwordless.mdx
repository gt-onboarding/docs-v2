...
Tout d’abord, [configurez la trousse SDK Android](/docs/fr-CA/fr-ca/libraries/auth0-android) de manière à pouvoir utiliser les méthodes sans mot de passe ci-dessous.
