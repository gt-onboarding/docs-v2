...
La plupart des trousses SDK OIDC et <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=oath2" tip="OAuth 2.0
...
3. Authentifiez l’utilisateur, en [envoyant le nombre aléatoire généré comme état](/docs/fr-CA/fr-ca/get-started/authentication-and-authorization-flow/implicit-flow-with-form-post/mitigate-replay-attacks-when-using-the-implicit-flow).
