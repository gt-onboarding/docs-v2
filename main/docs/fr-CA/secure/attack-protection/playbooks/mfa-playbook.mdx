...
Attackers can exploit and misuse <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=multifactor-authentication" tip="Authentification multifacteur (MFA)
...
The following log event types are relevant when investigating an MFA attack. They are found in the [Auth0 tenant logs](/docs/fr-CA/fr-ca/deploy-monitor/logs/log-event-type-codes).
