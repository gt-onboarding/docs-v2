...
3. Mettez le modèle à jour en conséquence. Vous pouvez utiliser n’importe laquelle des [variables communes](/docs/fr-CA/fr-ca/customize/email/email-templates#common-variables) disponibles pour personnaliser le message.
