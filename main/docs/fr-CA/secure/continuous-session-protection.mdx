...
<table class="table">
  ...
  <tbody>
    <tr>
      <td><a href="/docs/fr-CA/fr-ca/secure/tokens/refresh-tokens/manage-refresh-tokens-actions">Jetons d’actualisation avec les actions</a></td>
      <td>Comment gérer les jetons d’actualisation avec les actions</td>
    </tr>

    <tr>
      <td><a href="/docs/fr-CA/fr-ca/manage-users/sessions/manage-sessions-actions">Sessions avec les actions</a></td>
