...
Sender constraining is an <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=oath2" tip="OAuth 2.0
Cadre d’applications d’autorisation qui définit les protocoles d’autorisation et les flux de production." cta="Voir le glossaire">OAuth 2.0</Tooltip> and <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=openid" tip="OpenID
...
To learn more, read [mTLS Sender Constraining](/docs/fr-CA/fr-ca/secure/sender-constraining/mtls-sender-constraining) and [Demonstrating Proof-of-Possession (DPoP)](/docs/fr-CA/fr-ca/secure/sender-constraining/demonstrating-proof-of-possession-dpop).
...
<table class="table">
  ...
  <tbody>
    <tr>
      <td><a href="/docs/fr-CA/fr-ca/secure/sender-constraining/mtls-sender-constraining">mTLS Sender Constraining</a></td>
      <td>How mTLS sender constraining works in Auth0, step by step.</td>
    </tr>

    <tr>
      <td><a href="/docs/fr-CA/fr-ca/secure/sender-constraining/demonstrating-proof-of-possession-dpop">Demonstrating Proof-of-Possession (DPoP)</a></td>
      <td>How DPoP works in Auth0, step by step.</td>
    </tr>

    <tr>
      <td><a href="/docs/fr-CA/fr-ca/secure/sender-constraining/configure-sender-constraining">Configure Sender Constraining</a></td>
...
* [mTLS Sender Constraining](/docs/fr-CA/fr-ca/secure/sender-constraining/mtls-sender-constraining)
* [Demonstrating Proof-of-Possession (DPoP)](/docs/fr-CA/fr-ca/secure/sender-constraining/demonstrating-proof-of-possession-dpop)
* [Configurer la restriction de l’expéditeur](/docs/fr-CA/fr-ca/secure/sender-constraining/configure-sender-constraining)