...
[Configurer la rotation des jetons d’actualisation](/docs/fr-CA/fr-ca/secure/tokens/refresh-tokens/configure-refresh-token-rotation) pour activer l’accès hors ligne et demandez la permission de l’accès hors ligne dans la trousse SDK du client.
