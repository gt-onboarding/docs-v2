...
L’utilisateur doit avoir activé une autre inscription <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=multifactor-authentication" tip="Authentification multifacteur (MFA)
...
* Lorsque vous utilisez l’[API MFA](/docs/fr-CA/fr-ca/secure/multi-factor-authentication/multi-factor-authentication-developer-resources/mfa-api), vous pouvez répertorier et retirer les enregistrements WebAuthn, mais vous ne pouvez pas les enregistrer.
