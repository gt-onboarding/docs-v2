...
Vous pouvez autoriser les mots de passe à usage unique (OTP) en tant que facteur MFA en utilisant l’<Tooltip href="/docs/fr-CA/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
