...
When your tenant or <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
...
You can toggle monitoring mode for a rule by updating the `action` object. To learn more, read [Configure Rules](/docs/fr-CA/fr-ca/secure/tenant-access-control-list/configure-rules).
...
* [Configure Rules](/docs/fr-CA/fr-ca/secure/tenant-access-control-list/configure-rules)
* [Use Cases](/docs/fr-CA/fr-ca/secure/tenant-access-control-list/use-cases)
* [Reference](/docs/fr-CA/fr-ca/secure/tenant-access-control-list/reference)