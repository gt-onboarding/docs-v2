...
<Tabs>
  <Tab title="Application Web traditionnelle">
    ...
    * [Guides de démarrage rapide pour applications Web classiques](/docs/fr-CA/fr-ca/quickstart/webapp)
  </Tab>
  ...
  <Tab title="Application native/mobile">
    ...
    * [Save and Renew Tokens for Android (Enregistrer et renouveler des jetons pour Android)](/docs/fr-CA/fr-ca/auth0-android-save-and-renew-tokens)
    * [Save and Renew Tokens for Swift (Enregistrer et renouveler des jetons pour Swift)](/docs/fr-CA/fr-ca/libraries/auth0-swift/auth0-swift-save-and-renew-tokens)
    * [Native/Mobile Apps Quickstarts (Démarrages rapides d’applications natives/mobiles)](/docs/fr-CA/fr-ca/quickstart/native)
  </Tab>

  <Tab title="Application à page unique">
    Nous vous recommandons d’utiliser la [trousse SDK Auth0 pour les applications à page unique (SPA)](/docs/fr-CA/fr-ca/libraries/auth0-single-page-app-sdk) pour effectuer l’entreposage des jetons, la gestion des sessions et d’autres détails.
    ...
    * Si vous avez une application à page unique (SPA) **sans** serveur dorsal correspondant, votre SPA devrait demander de nouveaux jetons au moment de la connexion et les stocker en mémoire sans aucune persistance. Pour effectuer des appels d’API, votre SPA utilisera alors la copie du jeton en mémoire.
    ...
    <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
      En conformité avec les spécifications OAuth2, lorsqu’un navigateur demande un jeton d’actualisation à partir du point de terminaison /token, Auth0 ne renverra un jeton d’actualisation que si la [Rotation des jetons d’actualisation](/docs/fr-CA/fr-ca/secure/tokens/refresh-tokens/refresh-token-rotation) est activée pour ce client.
    </Callout>
