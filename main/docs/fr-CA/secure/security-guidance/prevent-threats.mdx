...
Auth0 possède des [fonctions de protection](/docs/fr-CA/fr-ca/secure/attack-protection) contre certains types d&#39;attaques.
...
Une façon de vérifier les demandes envoyées est d’utiliser le [paramètre d’état](/docs/fr-CA/fr-ca/secure/attack-protection/state-parameters) du protocole <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=oath2" tip="OAuth 2.0
