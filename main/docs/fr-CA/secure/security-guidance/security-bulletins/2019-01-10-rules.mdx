...
* Du code de règle personnalisée, contenant une logique conditionnelle pour appliquer l’authentification multifacteur (<Tooltip href="/docs/fr-CA/fr-ca/glossary?term=multifactor-authentication" tip="Authentification multifacteur (MFA)
