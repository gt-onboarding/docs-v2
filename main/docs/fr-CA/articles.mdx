...
<Card title="Premiers pas" href="/docs/fr-CA/fr-ca/get-started">
  Apprenez les bases du développement de votre solution d’authentification.
</Card>

<Card title="S’authentifier" href="/docs/fr-CA/fr-ca/authenticate">
  Définissez vos applications et API et vérifiez l’identité d’un utilisateur ou appareil.
</Card>

<Card title="Gérer les utilisateurs" href="/docs/fr-CA/fr-ca/manage-users">
  Stockez et gérez les informations personnalisées de vos utilisateurs.
</Card>

<Card title="Personnaliser" href="/docs/fr-CA/fr-ca/customize">
...
<Card title="Sécuriser" href="/docs/fr-CA/fr-ca/secure">
...
<Card title="Déployer et surveiller" href="/docs/fr-CA/fr-ca/deploy-monitor">
  Déployez Auth0 pour vos applications et surveillez l’état et les événements du système.
</Card>

<Card title="Dépanner" href="/docs/fr-CA/fr-ca/troubleshoot">
