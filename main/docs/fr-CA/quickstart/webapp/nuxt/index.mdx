...
'og:description': Ce guide explique comment intégrer Auth0, ajouter l’authentification
  et afficher les renseignements de profil utilisateur dans une application monopage (SPA)
  qui utilise Nuxt.js, à l’aide de la Trousse de développement logiciel (SDK) Auth0 Nuxt.js.
'og:image': https://cdn2.auth0.com/docs/1.14553.0/img/share-image.png
'og:title': 'Trousse de développement logiciel (SDK) Auth0 Nuxt.js – Démarrages rapides : ajouter la connexion à votre Application Nuxt.js'
...
'twitter:description': Ce guide explique comment intégrer Auth0, ajouter l’authentification
  et afficher les renseignements de profil utilisateur dans une application monopage (SPA)
  qui utilise Nuxt.js, à l’aide de la Trousse de développement logiciel (SDK) Auth0 Nuxt.js.
'twitter:title': 'Trousse de développement logiciel (SDK) Auth0 Nuxt.js – Démarrages rapides : ajouter la connexion à votre Application Nuxt.js'
---
...
<Steps>
  ...
  <Step title="Installez la trousse de développement logiciel (SDK) Auth0 pour Nuxt" stepNumber={2}>
    ```shellscript
  ...
  <Step title="Configurez votre application Auth0" stepNumber={3}>
    ...
    <Tabs>
      ...
      <Tab title="Tableau de bord">
        ...
        5. Remplacez les valeurs du fichier `.env` par les valeurs **Domaine**, **ID client** et **Secret client** depuis l’Auth0 Dashboard
        ...
        **Origines Web autorisées :**
        ...
        <Info>
          ...
          **Origines Web autorisées** est un paramètre essentiel pour l’authentification silencieuse. Sans ce paramètre, les utilisateurs seront déconnectés lorsqu’ils actualiseront la page ou reviendront plus tard à votre application.
        </Info>
      </Tab>
    </Tabs>
  </Step>
  ...
  <Step title="Créer les composants Login, Logout et Profile" stepNumber={5}>
    ...
    <CodeGroup>
      ...
      // Simuler l'état de chargement pour améliorer l'expérience utilisateur
      onMounted(() => {
        pending.value = true
        nextTick(() => {
          pending.value = false
        ...
        <div class="app-container">
          <div class="main-card-wrapper">
            <img 
              ...
              class="auth0-logo"
            />
            <h1 class="main-title">Bienvenue sur Auth0 Nuxt</h1>
  ...
  <Step title="Lancer votre application" stepNumber={6}>
    ```shellscript
    npm run dev
    ```
  </Step>
...
<Check>
  **Point de contrôle**
  ...
  Vous devriez maintenant avoir une page de connexion Auth0 entièrement fonctionnelle, accessible à partir de votre [localhost](http://localhost:3000/).
</Check>