...
export const SignUpForm = () => {
   ...
   * 認証フローデモ（外部UIライブラリなし）
   * - Tailwindのみ、本番環境対応構造
   * - LocalStorageベースのアプリリスト + アプリごとのURL設定
   * - 3つのフロー:
   *   1) メニュー: 作成 | 統合 | サンプル
   *   2) アプリケーション作成 -> リストに追加後、統合フローに事前選択状態でルーティング
   *   3) 既存アプリとの統合: アプリを選択 + URLを保存 -> トースト通知
   */
