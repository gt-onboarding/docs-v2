  ...
  return (
    <div className="gap-5 flex justify-center p-6 bg-[radial-gradient(1200px_600px_at_50%_-10%,rgba(180,160,255,.45)_0%,rgba(255,235,240,.35)_40%,rgba(255,245,235,.6)_100%)]">
      <div className="w-[min(860px,90vw)] text-center px-0 py-2 md:px-6 md:py-12">
        <h1 className="mb-5 font-inter font-semibold text-5xl text-center text-gray-900 dark:text-white">Auth0 ドキュメント</h1>
  ...
  const languages = [
    {
      img: "react.svg",
      label: "React",
      href: "/docs/ja-JP/quickstart/spa/react",
    },
    {
      img: "angular.svg",
      label: "Angular",
      href: "/docs/ja-JP/quickstart/spa/angular",
    },
    {
      img: "nextjs.svg",
      label: "Next.js",
      href: "/docs/ja-JP/quickstart/webapp/nextjs",
    },
    {
      img: "apple.svg",
      label: "iOS",
      href: "/docs/ja-JP/quickstart/native/ios-swift",
    },
    {
      img: "android.svg",
      label: "Android",
      href: "/docs/ja-JP/quickstart/native/android",
    },
    {
      img: "java.svg",
      label: "Java",
      href: "/docs/ja-JP/quickstart/backend/java-spring-security5/interactive",
    },
    {
      img: "dotnet.svg",
      label: ".NET",
      href: "/docs/ja-JP/quickstart/backend/aspnet-core-webapi",
    },
    {
      img: "python.svg",
      label: "Python",
      href: "/docs/ja-JP/quickstart/backend/python",
    },
  ];
...
export const ProductGrid = () => {
  const products = [
    { label: "認証", href: "https://auth0.com/platform/authentication" },
    { label: "きめ細かな認可", href: "https://auth0.com/fine-grained-authorization" },
    { label: "AIエージェント向け Auth0", href: "https://auth0.com/ai" },
  ];
...
export const LearnBasicsGrid = () => {
  const items = [
    ...
    {
      title: "コミュニティ",
      desc: "質問、提案、製品に関するフィードバックのためのコミュニティに参加できます。",
    ...
    {
      title: "サポート",
      desc: "Auth0 の実装に関するサポートを受けることができます。",
