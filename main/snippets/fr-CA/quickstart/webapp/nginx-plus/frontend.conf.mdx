...
server {
    ...
    location / {
        ...
        # Les utilisateurs authentifiés avec succès sont relayés vers le backend,
        # avec la réclamation 'sub' transmise comme en-tête HTTP
        proxy_set_header username $jwt_claim_sub;
        proxy_set_header x-email $jwt_claim_email;
        #proxy_set_header x-custom $claim_name;             # réclamation avec espace de noms
