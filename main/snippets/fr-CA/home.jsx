    ...
    <div className="gap-5 flex justify-center p-6 bg-[radial-gradient(1200px_600px_at_50%_-10%,rgba(180,160,255,.45)_0%,rgba(255,235,240,.35)_40%,rgba(255,245,235,.6)_100%)]">
      <div className="w-[min(860px,90vw)] text-center px-0 py-2 md:px-6 md:py-12">
        ...
        <div className="flex justify-center mt-5">
          {/* Bannière mobile en mode clair (&lt; 420px, mode clair) */}
          <img
            noZoom
            src="/docs/images/home/banner-mobile.svg"
            alt="Bannière de la documentation Auth0"
            className="block w-full h-auto sm:hidden"
          />

          {/* Bannière pour ordinateur en mode clair (&gt;= 420px, mode clair) */}
          <img
            noZoom
          ...
          />
          {/* Bannière pour ordinateur en mode sombre (&gt;= 420px, mode sombre) */}
          <img
            noZoom
            src="/docs/images/home/banner-dark.svg"
            alt="Bannière de la documentation Auth0 (mode sombre)"
...
export const ProductGrid = () => {
  const products = [
    { label: "Authentification", href: "https://auth0.com/platform/authentication" },
    { label: "Autorisation à granularité fine", href: "https://auth0.com/fine-grained-authorization" },
    { label: "Auth0 pour les agents IA", href: "https://auth0.com/ai" },
  ];
